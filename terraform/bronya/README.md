# Bronya VM - Terraform Configuration

This directory contains Terraform configuration to deploy the Bronya VM on Proxmox.
...
# Network - Recommended: Static IP for Bronya
vm_ip_config = "ip=192.168.1.102/24,gw=192.168.1.1"
...
- IP: 192.168.1.102/24 (example - customize in tfvars)
...
- [Cyrene VM](../cyrene/) - Secondary Docker host (192.168.1.101)
